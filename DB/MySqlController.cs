...
namespace wuqizi
{
    class MySqlController
    {
        ...
        public static void Insert(Board board)
        {
            ...
            string sql = $"insert into board(id, start_time) values({board.Id}, '{startTime}')";
            DBMySql.Insert(sql);
        }
        ...
        public static void UpDateBoard(int id, Color color, DateTime end, int count)
        {
            ...
            string sql = $"update board set end_time='{endTimeStr}', result='{colorStr}', count={count} where id={id}";
            DBMySql.Update(sql);
        }
        ...
        public static DataSet GetFilledDataSet(string table)
        {
            ...
            DataSet ds = DBMySql.FillDataSet(sql);
            return ds;
        }
        ...
        public static List<Chess> FindLastAll(int boardId)
        {
            ...
            string sql = $"select * from chess where board_id={boardId}";
            List<Chess> list = DBMySql.GetChessByBoardId(sql);
            return list;
        }
        ...
        {           
            ...
            Board board = DBMySql.QueryBoard(sql);
            return board;
        }
